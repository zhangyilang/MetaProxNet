...
class MetaProxNet(MetaLearningAlgBase):
...
class MetaProxNetSGD(MetaProxNet):
    def __init__(self, args):
        super(MetaProxNetSGD, self).__init__(args)
...
class MetaProxNetMC(MetaLearningAlgBase):
    def __init__(self, args):
        super().__init__(args)
...
class LayerwiseMetaProxNet(MetaProxNet):
    def __init__(self, args):
